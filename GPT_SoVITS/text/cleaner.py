...
from text.pinyin_ex import find_custom_tone, find_pinyinex
...
def clean_text(text, language):
    ...
    fix_pinyins = find_pinyinex(norm_text)
    tone_data_list.extend(fix_pinyins)
    
    custom_tones = find_custom_tone(text)
    tone_data_list.extend(custom_tones)
